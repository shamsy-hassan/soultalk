  ...
  return (
    <div className="space-y-4">
      <div className="surface-panel p-5">
        <h1 className="text-2xl font-bold tracking-tight text-soultalk-dark-gray">{t('settings_title')}</h1>
      ...
      <div className="card p-5 rounded-2xl">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-soultalk-warm-gray text-soultalk-dark-gray hover:bg-gray-200 transition-colors"
        >
      ...
      <div className="card p-5 rounded-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <Link
            to="/privacy"
            className="flex items-center gap-2 p-3 rounded-xl bg-soultalk-warm-gray text-soultalk-dark-gray hover:bg-gray-200 transition-colors"
          >
