  ...
  return (
    <div className="relative flex-shrink-0">
      ...
      {Math.random() > 0.5 && ( // Keep Math.random for now as per original code
        <div className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-br from-heybuddy-coral to-heybuddy-lavender rounded-full flex items-center justify-center border-2 border-white shadow-sm">
